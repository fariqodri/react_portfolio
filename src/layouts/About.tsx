    ...
    <h3>About Creator</h3>
      <Project
        ...
        techs={[
          ...
          <Pill newWindow href={"https://drive.google.com/open?id=12qmy_XhSHp1PHwqtVu5Or4Mjt2wwQIr2"} hoverColor={"#0080FF"} style={{backgroundColor:"transparent", border:"1px solid #0080FF"}}>
