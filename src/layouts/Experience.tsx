...
import warpin from "../images/warpin.png"
import ksp from "../images/ksp.png"
...
const Experience: React.FunctionComponent<Props> = props => (
  <div id={props.id} style={{...props.style, paddingLeft: "5vw"}} className={props.className}>
    ...
    <Timeline>
      <TimelineEvent
        title = {<div style={{fontSize: "1.05rem"}}><a target={"_blank"} href={"https://warungpintar.co.id/"}>Warung Pintar</a></div>}
      ...
      <TimelineEvent
        title = {<div style={{fontSize: "1.05rem"}}><a target={"_blank"} href={"http://www.ksp.go.id/"}>Presidential Staff Office of Republic of Indonesia (Kantor Staf Presiden Republik Indonesia)</a></div>}
      ...
      >
        <p>My main task was to create a chat bot for "LAPOR!" using Laravel 
          ...
          version of "LAPOR!" website. I was also given a <span><a target={"_blank"} href={"https://drive.google.com/open?id=1hOGDLYfAf2Bp7erLsoA_UPq1Ptp6hG2R"}>
