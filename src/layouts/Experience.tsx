...
import tiket from "../static/images/tiket_logo.jpg"
  ...
  <div id={props.id} style={{...props.style, paddingLeft: "5vw"}} className={props.className}>
    ...
    <Timeline>
      ...
      <TimelineEvent
        ...
        subtitle = {<p>December 2021 - September 2022</p>}
        bubbleStyle={{borderColor: "transparent"}}
      ...
      <TimelineEvent
        ...
        subtitle = {<p>April 2022 - September 2022</p>}
        bubbleStyle={{borderColor: "transparent"}}
      ...
      <TimelineEvent
        title = {<div style={{fontSize: "1.05rem"}}><a rel={"noopener noreferrer"} target={"_blank"} href={"https://tiket.com"}>Tiket.com</a></div>}
        subtitle = {<p>September 2022 - Present</p>}
        bubbleStyle={{borderColor: "transparent"}}
        icon={<LazyLoad><img style={{borderRadius: "50%"}} src={tiket} width={"100%"} height={"100%"}/></LazyLoad>}
      >
        <p>
          Tiket.com is one of the biggest online travel agent (OTA) company in Indonesia, if not Southeast Asia. As a data engineer, some of the projects or BAU I have been a part of are:
        </p>
        <ul>
          <li>
            End-to-end CDC Mongo and MySQL pipeline
          </li>
          <li>
            Cost optimization through various means
          </li>
          <li>
            Provision, maintenance, optimization, and troubleshooting of Spark clusters
          </li>
          <li>
            Research and experiments on various new technology and techniques
          </li>
        </ul>
      </TimelineEvent>
      <TimelineBlip
